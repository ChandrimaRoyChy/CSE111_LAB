...
Original file is located at
    https://colab.research.google.com/drive/1bkICp-tek_aoJDrWewhtLTDCPHrmOCJC
"""
...
print("SubTask-2:Printed different,because every object has particular object location.So,the locations can't be same")
print("SubTask3:Printed same,because here I changed the value of j2.name ='Health Ledger' and that's why,the value will be same.It doesn't mean the location is same.")
...
class box:
  def __init__(self,list1):
    ...
    volume=list1[0]*list1[1]*list1[2]
...
class buttons:
  def __init__(self,word,spaces,border):
    ...
    self.spaces=spaces
    self.border=border
    length=1+spaces+len(word)+spaces+1
    print(self.word,'Button Specifications:')
    print('Button name:',self.word)
    print('Number of the border characters for the top and the bottom:',length)
...
wadiya.num_of_wife=1adiya.dictator=False
print("Name:",wadiya.name)
print("Designation:",wadiya.designation)
print("Number of wife:",wadiya.num_of_wife)
print("Is he/she a dictator:",wadiya.dictator)
...
class StudentDatabase:
  def __init__(self,name,ID):
    ...
    def calculateGPA(self,grade_list,sem):
      ...
      self.grade[sem]={tuple(course_lst):CGPA}
